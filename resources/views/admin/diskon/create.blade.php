...
@section('header', 'Tambah Promo / Diskon')
...
<div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.diskon.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="Kode_Diskon" value="{{ old('Kode_Diskon') }}" required 
        ...
        <div class="mb-4">
            ...
            <input type="number" name="Persentase" value="{{ old('Persentase') }}" required min="1" max="100"
        ...
        <div class="mb-6">
            ...
            <select name="Statues" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-black focus:border-black">
                <option value="Aktif" {{ old('Statues') == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                <option value="Tidak Aktif" {{ old('Statues') == 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
            </select>
        </div>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800">Simpan Promo</button>
        </div>
    </form>
</div>
@endsection
